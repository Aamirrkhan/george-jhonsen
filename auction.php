        ...
        <div class="row justify-content-center">
            <div class="col-12">
                <!-- <div class="micro-textarea text-center">
                    <h1>MICRO-TRAINS LINE</h1>
                    <h6>PRODUCTION STOCK NUMBERS</h6>
                    <p>NOTE: the 5-digit number series was converted to an 8-digit number in January 2005</p>
                    <h5>MICRO-TRAINS N & Z SCALE ROLLING STOCK</h5>
                </div> -->
        ...
        <div class="row">
            <div class="col-lg-6 col-12">
                <div class="auction-img">
                    <div class="clock-area">
                        <ul id="timecounter" class="counter-flex">
                            <li class="circle clockbg"><span class="clock-icon"><i class="fa-regular fa-clock"></i></span></li>
                            <li class="circle"><span class="days"></span>DAYS</li>
                            <li class="circle"><span class="hours"></span>HOURS</li>
                            <li class="circle"><span class="minutes"></span>MINS</li>
                            <li class="circle"><span class="seconds"></span>SECS</li>
                    ...
                    <div class="aution-img"><img src="assets/images/auction1.png" class="img-fluid w-100"></div>
                </div>
            </div>
            <div class="col-lg-6 col-12 bg-gray-light">
                <div class="aution-scal-text">
                    <h1>N Scale Enthusiast <span class="primary-color">Live Auction</span></h1>
                    <p>The N Scale Enthusiast Conventions are full of traditions and friendships and we continue to create them. When we were but a young group, we started doing the things that our members wanted, and that developed into a set of standards that have become a loose framework for all of our conventions. This is not to say that we do not vary, as our group has grown with new members and new ideas that we try to incorporate into the schedule. However, the basic schedule for the convention hasn't changed dramatically in years, and the events are pretty much what folks have come to expect. Yes, we switch days now and again to accommodate an attraction’s availability, but we pretty much stick to the same kind of schedule throughout. We do make exceptions for times when we can be the “National N Scale Convention” in association with another N Scale groups.</p>
        ...
        <div class="row">
            <div class="col-12 col-lg-6">
                <div class="auction-rules-textarea ">
                    ...
                    <!-- <div class="accordion auction-list" id="accordionExample">
                            ...
                            <div class="accordion-item">
                                ...
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                    3. So you want to bid on our NSE auctions. Here’s how you do it…
                                </button>
                                </h2>
                                <div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                    Placing bids on our NSE auctions is simple and easy. Over 95% of our members bid via email, but you can also submit bids by snail-mail if necessary. If you choose to bid by mail, you only need to submit a list of the item numbers and your bid amount for each item. Also make sure to include your name and member number.
                                        ...
                                        Winning bidders who have an email address on file receive an “e-invoice with their amount due (if they do not pay via credit card on file). A confirming reply of the email message and prompt payment of the total due is expected. If the member does not have email access, they must supply us with a daytime telephone number so that we can call them with their invoice amount due. We do not mail invoices. It simply takes too long to receive payments. All non credit card payments are due upon receipt of the e-Invoice and we must receive all payments within 10 days thereafter. All member/bidders receive a “paid” invoice with their auction shipments.
                            ...
                            <div class="accordion-item">
                                ...
                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="true" aria-controls="collapsefour">
                                     4. Now that you know how to bid, what about selling on our NSE auctions…
                                </button>
                                </h2>
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="collapsefive" class="accordion-collapse collapse show" aria-labelledby="headingfive" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <br>
                                        (A):     Our Auction Master, Doug Hickman, can answer any additional questions you may have. You can reach him at auctions@nscaleenthusiast.com or by phone during normal east coast business hours at (231) 676-3300
                                    </div>
                                </div>
                            </div>
                        </div> -->
