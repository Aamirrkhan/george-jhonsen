            ...
            <div class="col-xl-5 col-lg-6 col-12">
                <div class="row">
                    <div class="col-12 mb-3">
                        ...
                        reset <span class="black">PASSWORD</span>
                        </h1>
                    </div>
                    <div class="col-12">
                        <div class="logoform-input">
                            <label for="Password" class="w-100"> Password
                                <input type="password" placeholder="New Password" class="w-100 login-fields">
                                <input type="password" placeholder="Conform Password" class="w-100 login-fields">
                            </label>
                        </div>
                    </div>
                    <div class="col-12">
