                                    ...
                                    <ul class="contacts">
                                        ...
                                        <li>
                                            <div class="d-flex bd-highlight">
                                                ...
                                                <div class="ms-auto">
                                                    <a href="#" class="btn btn-primary btn-xs sharp me-1"><i class="fas fa-pencil-alt"></i></a>
                                                    <a href="#" class="btn btn-danger b tn-xs sharp"><i class="fa fa-trash"></i></a>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
            ...
            <div class="deznav">
                <div class="deznav-scroll">
                    <ul class="metismenu" id="menu">
                        <li class="has-menu"><a class="has-arrow ai-icon" href="javascript:void(0)" aria-expanded="false">
                                <i class="flaticon-381-networking"></i>
                                <span class="nav-text">Dashboard</span>
                            </a>
                            <ul aria-expanded="false">
                                <li><a href="index.php">Dashboard Light</a></li>
                                <li><a href="index2.php">Dashboard Dark</a></li>
                                <li><a href="search-job.php">Search Job</a></li>
                                        ...
                                        <table class="table table-responsive-md">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="d-flex align-items-center"><img src="public/images/avatar/1.jpg" class="rounded-lg me-2" width="24" alt="" /> <span class="w-space-no">Dr. Jackson</span></div>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong>542</strong></td>
                                                    <td>
                                                        <div class="d-flex align-items-center"><img src="public/images/avatar/2.jpg" class="rounded-lg me-2" width="24" alt="" /> <span class="w-space-no">Dr. Jackson</span></div>
                                                    </td>
                                                    <td>example@example.com </td>
                                                    <td>01 August 2020</td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><strong>542</strong></td>
                                                    <td>
                                                        <div class="d-flex align-items-center"><img src="public/images/avatar/3.jpg" class="rounded-lg me-2" width="24" alt="" /> <span class="w-space-no">Dr. Jackson</span></div>
                                                    </td>
                                                    <td>example@example.com </td>
                                                    <td>01 August 2020</td>
                                                    <td>
                                        ...
                                        <table class="table table-bordered verticle-middle table-responsive-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span>
                                                            <a href="javascript:void(0)" class="me-4" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-pencil-alt color-muted"></i> </a>
                                                            <a href="javascript:void(0)" data-bs-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a>
                                                        </span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    ...
                                                    <td><span><a href="javascript:void(0)" class="me-4" data-bs-toggle="tooltip" data-placement="top" title="Edit"><i class="fas fa-pencil-alt color-muted"></i> </a><a href="javascript:void(0)" data-bs-toggle="tooltip" data-placement="top" title="Close"><i class="fa fa-close color-danger"></i></a></span>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>Milk Powder</td>
