<!DOCTYPE php>
<php lang="en">
  <!-- Mirrored from jobie.dexignzone.com/laravel/demo/index by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 06 May 2024 23:11:49 GMT -->
  <!-- Added by HTTrack -->
            ...
            <div class="collapse navbar-collapse justify-content-between">
              ...
              <ul class="navbar-nav header-right">
                ...
                <li class="nav-item dropdown notification_dropdown">
                  <a class="nav-link bell bell-link" href="./chats.php">
