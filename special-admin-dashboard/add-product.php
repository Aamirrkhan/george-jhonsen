                                        ...
                                        <div class="row">
                                            <div class="col-xl-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control discription-product" rows="6"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-6">
                            <div class="card  flex-lg-column flex-md-row ">
                                <div class="card-body card-body  text-center border-bottom profile-bx boder-layer">
                                    <div class="profile-imagez mb-4">
                                        <label>Upload Product Image</label>
                                        <img src="public/images/products/image.png" class="rounded-circle productImg-show" alt="">
                                        <div class="form-group">
                                            <input type="file" class="form-control" id="uploadImage-product">
                                        </div>
                                    </div>
                                    <div class="profile-imagez gallery-images mb-4">
                                        <!-- <div class="gallery-flex">
                                            <div class="position-relative">
                                                <button>X</button>
                                                <img src="public/images/products/image.png" class="rounded-circle gallery-show" alt="">
                                            </div>
                                        </div> -->
...
?>
<script>
    document.getElementById('uploadImage-product').addEventListener('change', function(event) {
        const file = event.target.files[0];
        if (file) {
            const reader = new FileReader();
            reader.onload = function(e) {
                document.querySelector('.productImg-show').src = e.target.result;
            }
    ...
    document.getElementById('multiimg-product').addEventListener('change', function(event) {
        ...
        for (const file of files) {
            ...
            reader.onload = function(e) {
                ...
                img.classList.add('pro-galleryImg');
                img.alt = '';
