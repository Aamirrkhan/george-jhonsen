      ...
      <div class="deznav">
        <div class="deznav-scroll">
          <ul class="metismenu" id="menu">
            ...
            <li class="has-menu dropdown-list">
              <a class="has-arrow ai-icon" href="./users.php" aria-expanded="false">
                ...
                <ul class="metismenu" id="menu">
                  ...
                  <li class="has-menu">
                    <a class="has-arrow ai-icon" href="./add-user.php" aria-expanded="false">
                      <i class="flaticon-381-networking"></i>
            ...
            <li class="has-menu dropdown-list">
              <a class="has-arrow ai-icon" href="./roles.php" aria-expanded="false">
                <i class="flaticon-381-networking"></i>
                ...
                <ul class="metismenu" id="menu">
                  ...
                  <li class="has-menu">
                    <a class="has-arrow ai-icon" href="./add-role.php" aria-expanded="false">
                      <i class="flaticon-381-networking"></i>
                      <span class="nav-text">Add Role
                      </span>
                    </a>
                  </li>
                </ul>
