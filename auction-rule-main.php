        ...
        <div class="row">
            <div class="col-12">
                <div class="auction-rule-1">
                    <div class="auct-hd">
                        <h2>1. When do we publish the Auction rules?</h2>
                    </div>
                    <div class="auct-para">
                        <p>
                ...
                <div class="auction-rule-1">
                    <div class="auct-hd">
                        <h2>2. Here’s how the NSE auction process works…and how you understand our lists.</h2>
                    </div>
                    <div class="auct-para">
                        <p>
                ...
                <div class="auction-rule-1">
                    <div class="auct-hd">
                        <h2> 3. You want to place some bids on our auctions. Here’s how you do it…</h2>
                    </div>
                    <div class="auct-para">
                        <p>
                ...
                <div class="auction-rule-1">
                    <div class="auct-hd">
                        <h2> 4.Now, we’ll explain how to sell items on our NSE auctions…</h2>
                    </div>
                    <div class="auct-para">
                        <p>
                    ...
                    <div class="accordion" id="accordionExample">
                        ...
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                How long does it take for my auction items to sell?
                            </button>
                            </h2>
                            <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Usually only a few months, but sometimes longer. We try to only accept items that will appear in the next several auctions, but sometimes the seller waits to send his items to us. By then, we have already received the same items from other sellers (remember, first-in, first-out and no reserved positions), thus moving this seller’s items further down the waiting list.
                            </div>
                            </div>
                        </div>
                        <div class="accordion-item">
                        ...
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                                What does the N-Scale Enthusiast do with all the profits generated from these auctions?
                            </button>
                            </h2>
                        ...
                        <div class="accordion-item">
                            ...
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsesix" aria-expanded="false" aria-controls="collapsesix">
                                What if I have some other auction seller questions?
                            </button>
                            </h2>
                            <div id="collapsesix" class="accordion-collapse collapse" aria-labelledby="headingsix" data-bs-parent="#accordionExample">
                            <div class="accordion-body">
                                Our Auction Master, Doug Hickman, can answer any additional questions you may have. You can reach him at auctions@nscaleenthusiast.com or by phone during normal east coast business hours at (231) 676-3300
                            </div>
                            </div>
                        </div>
                    </div>
