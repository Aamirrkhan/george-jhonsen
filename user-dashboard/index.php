          ...
          <div class="card-body">
            <div class="media align-items-center">
              ...
              <div class="media-body text-end feature-icon-text">
                <p class="fs-18 text-white mb-2">Auctions</p>
        ...
        <div class="card bg-info overflow-hidden">
          <div class="card-body">
            <div class="media align-items-center">
              ...
              <div class="media-body text-end feature-icon-text">
                <p class="fs-18 text-white mb-2">Custom Bids</p>
        ...
        <div class="card bg-success">
          <div class="card-body">
            <div class="media align-items-center">
              ...
              <div class="media-body text-end feature-icon-text">
                <p class="fs-18 text-white mb-2">Checkout</p>
            ...
            <div class="card d-flex flex-xl-column flex-sm-column flex-md-row flex-column">
              <div class="card-body text-center profile-bx">
                <div class="profile-image mb-4">
                  <img src="public/images/avatar/1.jpg" class="rounded-circle" alt="" />
                </div>
              ...
              <div class="card-body col-xl-12 col-md-6 col-sm-12 activity-card">
                ...
                <div class="media mb-4">
                  ...
                  <div class="media-body">
                    <p class="fs-14 mb-1 text-black font-w500">
            ...
            <div class="card">
              <div class="card-header border-0 pb-0 flex-wrap">
                ...
                <div class="form-check custom-checkbox mb-3">
                  ...
                  <label class="form-check-label" for="customCheckBox1">Auction</label>
                </div>
                <div class="form-check custom-checkbox mb-3">
                  <input type="checkbox" class="form-check-input" id="customCheck1" required />
                  <label class="form-check-label" for="customCheck1">Customs Bids</label>
                </div>
                <div class="form-check custom-checkbox mb-3">
